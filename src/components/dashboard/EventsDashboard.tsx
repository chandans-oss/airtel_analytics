        ...
        <div className="space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <span className="text-[10px] font-bold uppercase text-muted-foreground mr-2">Last 30 Days</span>
                    <div className="flex gap-2">
                        <button className="p-2 rounded-lg bg-card border border-border/50 hover:bg-muted transition-colors text-muted-foreground"><Search size={16} /></button>
                        <button className="p-2 rounded-lg bg-card border border-border/50 hover:bg-muted transition-colors text-muted-foreground"><Filter size={16} /></button>
                        <button className="p-2 rounded-lg bg-card border border-border/50 hover:bg-muted transition-colors text-muted-foreground"><Download size={16} /></button>
                    </div>
                </div>
            </div>
            ...
            <div className="rounded-xl border border-border/50 bg-card p-5 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <button onClick={() => handleExport(LINK_DOWN_ISSUES, 'Link_Down_Issues')} className="p-1.5 rounded-md hover:bg-muted text-muted-foreground transition-all" title="Export CSV">
                        <Download size={14} />
                    </button>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {LINK_DOWN_ISSUES.map((item, idx) => (
                        <div key={idx} className={cn("p-4 rounded-lg border flex flex-col items-center justify-center text-center transition-all hover:scale-105 cursor-default", item.border, item.bg)}>
                            <p className={cn("text-3xl font-black mb-1", item.color)}>{item.value}</p>
